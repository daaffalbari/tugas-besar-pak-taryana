		 ...
		 <center>
		 	<table border="0">
		 		<?php 
		 			...
		 			echo "<br><img src='./images/$kodebrg.jpg' width=30% height=35%><br><br>";
		 	...
		 	<hr width="400">
		 	<button type="submit" class="w3-btn w3-round-xxlarge w3-green">Simpan Pembelian</button>
		 	<a href="index.php" class="w3-btn w3-round-xxlarge w3-red">Kembali ke Toko</a>
		 </center>
	</form>
</html>